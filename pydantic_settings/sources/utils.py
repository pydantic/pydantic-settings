...
def _annotation_is_complex(annotation: type[Any] | None, metadata: list[Any]) -> bool:
    """Check if a type annotation represents a complex type that needs JSON parsing."""
    from pydantic import Json, RootModel, Secret
...
def _annotation_is_complex_inner(annotation: type[Any] | None) -> bool:
    """Check if a type annotation represents a complex type (internal helper)."""
...
def _strip_annotated(annotation: Any) -> Any:
    """Strip Annotated wrapper from a type annotation."""
...
def _annotation_enum_val_to_name(annotation: type[Any] | None, value: Any) -> Optional[str]:
    """Convert an enum value to its name based on the type annotation."""
...
def _annotation_enum_name_to_val(annotation: type[Any] | None, name: Any) -> Any:
    """Convert an enum name to its value based on the type annotation."""
    from enum import Enum
