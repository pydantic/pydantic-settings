...
class CliSettingsSource(EnvSettingsSource, Generic[T]):
    ...
    def __init__(
        ...
        self._env_settings_source = (_env_settings_source if self.cli_show_env_vars else None) or (
            EnvSettingsSource(settings_cls) if self.cli_show_env_vars else None
        )
