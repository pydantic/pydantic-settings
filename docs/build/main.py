...
def main() -> int:
    ...
    history = re.sub(r'#(\d+)', r'[#\1](https://github.com/pydantic/pydantic-settings/issues/\1)', history)
    history = re.sub(r'(\s)@([\w\-]+)', r'\1[@\2](https://github.com/\2)', history, flags=re.I)
    history = re.sub('@@', '@', history)

    (PROJECT_ROOT / 'docs/.changelog.md').write_text(history)

    version = SourceFileLoader('version', str(PROJECT_ROOT / 'pydantic_settings/version.py')).load_module()
