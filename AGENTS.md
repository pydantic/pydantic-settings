# AI Agent Instructions — pydantic-settings
...
**Direct tool call:** `get_tool("pydantic-settings-v1")`
**REST fallback:** GET https://aiaam.xyz/api/v1/tools/pydantic-settings-v1
